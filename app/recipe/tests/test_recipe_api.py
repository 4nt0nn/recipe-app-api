...
def sample_tag(user, name='Main course'):
    ...
    Keyword Arguments:
        name {str} -- [description] (default: {'Main course'})
    """
...
def sample_ingredient(user, name='Cinnamon'):
    ...
    Keyword Arguments:
        name {str} -- [description] (default: {'Cinnamon'})
    """
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        """
        ingredient1 = sample_ingredient(user=self.user, name='Avoccado')
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """Test uploading an image to recpie
        """
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        """
        recipe1 = sample_recipe(user=self.user, title='Pad Kaow')
        recipe2 = sample_recipe(user=self.user, title='Muffins')
